...
const ElderMessage = () => {
  return (
    <section className="bg-gray-100 py-12 px-6 lg:px-24 text-gray-800 font-sans">
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 md:p-10">
        ...
        <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
          ...
          />
          <div>
            <h1 className="text-3xl font-bold text-blue-800 mb-2">Word From the First Elder</h1>
