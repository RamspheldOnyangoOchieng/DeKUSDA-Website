...
const LiteratureMinistry = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="w-full bg-gradient-to-r from-primaryBlue to-darkBlue text-white py-6 px-4 text-center">
        <h1 className="text-2xl md:text-3xl font-bold mb-2">
          Literature Ministry Department
        </h1>
        <p className="italic text-sm md:text-base max-w-3xl mx-auto">
          “Fulfilling the great commission through the printed page”
        </p>
      </div>

      <main className="px-6 md:px-20 py-10 text-gray-800 font-sans bg-gray-50">
        {/* Vision */}
