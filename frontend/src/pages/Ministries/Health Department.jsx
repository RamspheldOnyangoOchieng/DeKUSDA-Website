  ...
  return (
    <section className="w-full bg-white py-12 px-4 md:px-16 text-gray-800">
      <div className="max-w-4xl mx-auto space-y-8">
        {/* Heading */}
        <h2 className="text-3xl font-bold text-primaryBlue text-center">
          Health Class Ministry
        </h2>
        ...
        <blockquote className="bg-primaryBlue/10 border-l-4 border-primaryBlue px-6 py-4 rounded-lg italic text-darkBlue">
        ...
        {/* Bible Verse */}
        <div className="text-lg font-semibold italic text-center text-darkBlue">
