  ...
  return (
    <section className="bg-white py-12 px-6 lg:px-24">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-4xl font-bold text-blue-800 mb-4">Church Choir</h2>
      ...
      <div className="mt-12 text-center">
        <input
          ...
          className="border border-blue-300 px-4 py-2 rounded-md w-full max-w-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          value={searchTerm}
              ...
              >
                <div className="relative">
                  <img
                    ...
                    alt={video.title}
                    className="rounded-lg shadow-md w-full transition-transform group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg opacity-0 group-hover:opacity-100 transition">
                    <svg
                ...
                <p className="mt-2 text-center text-blue-800 font-medium">{video.title}</p>
              </div>
            ))}
          </div>
        ) : (
          <p className="text-center text-gray-500 mt-6">No videos match your search.</p>
        )}
      </div>
