...
import churchChoirImage from '../../assets/churchchoir.jpeg';
...
export const ChurchChoir = () => {
  ...
  return (
    <>
      ...
      <section className="px-6 py-12 bg-gray-100 font-sans text-gray-800 min-h-screen lg:px-24">
        {/* Intro Section */}
        <div className="grid gap-10 items-center md:grid-cols-2">
          <div>
            <img
              src={churchChoirImage}
              alt="Church Choir"
