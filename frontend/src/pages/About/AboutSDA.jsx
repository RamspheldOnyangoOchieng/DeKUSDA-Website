...
const AboutSDA = () => {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-yellow-400 via-red-500 to-green-900">
            <h1 className="mb-4 text-4xl font-bold text-white">About SDA</h1>
            <p className="mb-8 text-lg text-white">Welcome to the SDA page! Here, you can find a collection of beautiful hymns sung by our talented choir members.</p>
