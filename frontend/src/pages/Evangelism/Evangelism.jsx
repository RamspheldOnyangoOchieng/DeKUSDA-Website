...
const Evangelism = () => {
  return (
    <>
      ...
      <main className="bg-white text-gray-800 font-sans px-6 py-10">
        <section className="max-w-5xl mx-auto bg-gray-50 rounded-2xl shadow-md px-6 py-10">
          ...
          <div className="text-lg text-gray-700 space-y-6">
            ...
            <blockquote className="italic text-green-700 border-l-4 pl-4 border-green-500">
