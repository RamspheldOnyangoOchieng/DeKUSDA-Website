            ...
            <ul className="text-sm text-blue-900 space-x-4 flex">
              ...
              <li className='relative z-50 group'>
                ...
                <ul className='absolute left-0 -mt-6 lg:w-36 bg-neutral-100 shadow-lg hidden group-hover:block space-y-4 pt-2 border border-neutral-200'>
                  ...
                  <li className='pl-2 hover:underline'><Link to="/Music/Blissful">Blissful Tones</Link></li>
              ...
              {/* Gallery */}
              <li className='my-10 xl:text-lg lg:text-[1rem] font-georgia font-normal'><Link to="/Gallery">Gallery</Link></li>
              ...
              <li className='relative z-50 group'>
                ...
                <ul className='absolute left-0 -mt-6 lg:w-28 bg-neutral-100 shadow-lg hidden group-hover:block space-y-4 pt-2 border border-neutral-200'>
              ...
              {/* Contact */}
              <li className='my-10 xl:text-lg lg:text-[1rem] font-georgia font-normal'><Link to="/Contact">Contact</Link></li>
